 ...
 *    under the License.
 **/
package net.floodlightcontroller.l2_pairs;
...
public class L2_Pairs implements IOFMessageListener, IFloodlightModule {

    protected static Logger log = LoggerFactory.getLogger(L2_Pairs.class);
